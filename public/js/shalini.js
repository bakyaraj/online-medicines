  ...
  function setNavigation() {
      ...
      $("#main-nav a").each(function () {
          ...
          if (path.substring(0, href.length) === href) {
              $(this).closest('li a').addClass('current-page');
...
/*=====================================================
 Article last class adding for 3-col layouts
 ======================================================*/
$('.three-col-layout article:nth-child(3n+3)').addClass('three-col-last');  
  
  $(window).resize(function() {
   var width = $(window).width();
   if (width <= 480 && width >= 320) {
      $('.three-col-layout article:nth-child(3n+3)').removeClass('three-col-last');
      $('.three-col-layout article:nth-child(2n+2)').addClass('two-child-last');
    }
    else if (width <= 1024 && width >= 768) {
      $('.three-col-layout article:nth-child(2n+2)').removeClass('two-child-last');
      $('.three-col-layout article:nth-child(3n+3)').addClass('three-col-last');
...
$(document).ready(function(){
  ...
  if (document_width >= 768) {
    // alert("inside adjust height");
    $(".row .service-title-container").closest(".row").each(function(rowi) {
      var maxHeight = 0;
      $(this).find(".service-title").each(function(idx){
        var h = $(this).height();
        if (h > maxHeight) {
          maxHeight = h
        }
    ...
    $(".service-title").each(function(idx){
